...
export interface DriftSummary {
  ...
  axisAverageChanges: Record<string, number>;
}

export function computeEmotionalDriftOverLastN(events: ELangVector[], lastN: number): DriftSummary {
  ...
  const axisAverageChanges: Record<string, number> = {};
