...
import { computeEnergyAwareAdjustment } from "../../src/core/cognition/goalScheduler.js";
import type { Goal } from "../../src/core/cognition/goalMemory.js";
import type { SchedulerState } from "../../src/core/cognition/schedulerState.js";
...
describe("goalScheduler energy-aware scoring", () => {
  ...
  it("keeps old goals without scheduling hints runnable", () => {
    const state: SchedulerState = {
      strainScore: 0.7,
      volatilityScore: 0.7,
      stabilityScore: 0.3,
