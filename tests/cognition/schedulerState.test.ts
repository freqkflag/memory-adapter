...
import type { MemoryItem } from "../../src/memory/MemoryItem.js";
import {
  deriveSchedulerStateFromMemories,
  getNeutralSchedulerState
} from "../../src/core/cognition/schedulerState.js";

function makeEmotionMemory(id: string, text: string, timestamp: number): MemoryItem {
  return {
    id,
    text,
    domain: "emotion",
